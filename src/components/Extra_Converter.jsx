...
//     setOptionsList(temp);
//   }
//   let [previous_first_currency,previous_second_currency] = useRef();
...
//   // previous_first_currency = firstCurrency;
//   // previous_second_currency = secondCurrency;

//   // defaultfirstCurrency = previous_second_currency;
//   // defaultsecondCurrency = previous_first_currency;
...
//           {swap ? <Selection1></Selection1> :<Selection2></Selection2>}
...
// //   const updatedList = optionsList.map((element)=>{
// //     if(element.value === firstCurrency){
